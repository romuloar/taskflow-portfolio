    ...
    public class BaseRepositoryTest
    {
        ...
        public async Task AddAsync_Should_Add_Entity()
        {
            ...
            var task = new TaskDomain
            {
                ...
                Status = Workflow.Domain.Generic.Task.EnumTaskStatus.New
            };
        ...
        public async Task GetAllAsync_Should_Return_All_Entities()
        {
            ...
            {
                new TaskDomain { Id = Guid.NewGuid(), Description = "Task 1", Status = Workflow.Domain.Generic.Task.EnumTaskStatus.New },
                new TaskDomain { Id = Guid.NewGuid(), Description = "Task 2", Status = Workflow.Domain.Generic.Task.EnumTaskStatus.Done }
            };
